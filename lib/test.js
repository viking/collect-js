define(function() {
  ...
  test.ConsoleLogger.prototype._indentString = function(level) {
    var indentStr = "";
  ...
  test.ConsoleLogger.prototype.print = function(info) {
    var indent1 = this._indentString(this._level);
    var indent2 = this._indentString(this._level + 1);

    switch (info.type) {
      case 'run':
        this._console.log(indent1 + "running suite: " + info.name);
        break;
      ...
      case 'success':
        this._console.log(indent2 + 'test "' + this._testName + '": success');
        break;

      case 'failure':
        this._console.log(indent2 + 'test "' + this._testName + '": failed');
        var indent3 = this._indentString(this._level + 2);
        info.callstack.forEach(function(line) {
          this._console.log(indent3 + line);
        }, this);
        break;
